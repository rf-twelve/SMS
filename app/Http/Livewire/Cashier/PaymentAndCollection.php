...
class PaymentAndCollection extends Component
{
    public $payment_id;
    ...
    {
        return SchoolFee::select('id','name',$this->student['grade_level'].' as amount')->get();
    }
    ...
    public function updated($variable){
        if($variable == 'scan_or_search' || $variable == 'amount'){
            ...
            if(isset($this->student)){
                $this->school_fees = $this->getSchoolFee();
    ...
    {
        return view('livewire.cashier.payment-and-collection');
    }
}
