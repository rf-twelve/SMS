<div class="sticky top-0 z-10 flex flex-shrink-0 h-16 bg-white border-b border-gray-200 lg:hidden">
    ...
    <button type="button" x-on:click="openSidebarMobile = true"
    ...
    <div class="flex justify-between flex-1 px-4 sm:px-6 lg:px-8">
        ...
        <div x-data={userDropdownMobile:true} class="flex items-center">
            <!-- Profile dropdown -->
            <div class="relative ml-3">
                <div>
                    <button x-on:click="userDropdownMobile = true" type="button"
