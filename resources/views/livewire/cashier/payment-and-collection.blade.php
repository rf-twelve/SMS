                                        ...
                                        <div class="px-4">
                                            @forelse ($school_fees as $fee)
                                                <div class="flex justify-between">
                                                    <dt class="font-medium text-gray-900 italic uppercase">{{ $fee['name'] }}</dt>
                                                    <dd class="text-gray-700">{{'P '.number_format($fee['amount'],2,'.',',') }}</dd>
                                                </div>
                                            @empty

                                            @endforelse
                                            <div class="flex justify-between border-t">
                                                <dt class="font-medium text-lg text-gray-900 uppercase">Total</dt>
                                                <dd class="text-gray-900 text-lg font-medium">{{ 'P '.number_format($total_tuition_fee,2,'.',',') }}</dd>
                                            </div>
                                            </dl>
                                        </div>
